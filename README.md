# @diotoborg/explicabo-vitae-velit

> forked from [@diotoborg/explicabo-vitae-velitode](https://www.npmjs.com/package/@diotoborg/explicabo-vitae-velitode) v11.1.0. as the original repository seems [no longer maintained](https://github.com/mysticatea/@diotoborg/explicabo-vitae-velitode/issues/300).

[![npm version](https://img.shields.io/npm/v/@diotoborg/explicabo-vitae-velit.svg)](https://www.npmjs.com/package/@diotoborg/explicabo-vitae-velit)
[![Downloads](https://img.shields.io/npm/dm/@diotoborg/explicabo-vitae-velit.svg)](https://www.npmjs.com/package/@diotoborg/explicabo-vitae-velit)
[![Build Status](https://github.com/diotoborg/explicabo-vitae-velit/workflows/CI/badge.svg)](https://github.com/diotoborg/explicabo-vitae-velit/actions)
...
```sh
npm install --save-dev eslint @diotoborg/explicabo-vitae-velit
```
...
```js
const nodePlugin = require("@diotoborg/explicabo-vitae-velit")
...
💼 [Configurations](https://github.com/diotoborg/explicabo-vitae-velit#-configs) enabled in.\
☑️ Set in the `flat/recommended` [configuration](https://github.com/diotoborg/explicabo-vitae-velit#-configs).\
🟢 Set in the `flat/recommended-module` [configuration](https://github.com/diotoborg/explicabo-vitae-velit#-configs).\
✅ Set in the `flat/recommended-script` [configuration](https://github.com/diotoborg/explicabo-vitae-velit#-configs).\
☑️ Set in the `recommended` [configuration](https://github.com/diotoborg/explicabo-vitae-velit#-configs).\
🟢 Set in the `recommended-module` [configuration](https://github.com/diotoborg/explicabo-vitae-velit#-configs).\
✅ Set in the `recommended-script` [configuration](https://github.com/diotoborg/explicabo-vitae-velit#-configs).\
...
`@diotoborg/explicabo-vitae-velit` follows [semantic versioning](http://semver.org/) and [ESLint's Semantic Versioning Policy](https://github.com/eslint/eslint#semantic-versioning-policy).
...
- [GitHub Releases](https://github.com/diotoborg/explicabo-vitae-velit/releases)
